...
- **Linux/macOS:** `bash .sumela/skills/systematic-debugging/find-polluter.sh <target-path> <test-pattern>`
- **Windows:** `.sumela\skills\systematic-debugging\find-polluter.cmd <target-path> <test-pattern>`
