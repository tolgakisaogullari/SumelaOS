...
**Linux/macOS:**
1. START: `.sumela/skills/brainstorming/scripts/start-server.sh --project-dir <path>`
...
3. STOP: `.sumela/skills/brainstorming/scripts/stop-server.sh $SCREEN_DIR`

**Windows (cmd.exe):**
1. START: `.sumela\skills\brainstorming\scripts\start-server.cmd --project-dir <path>`
2. Save `%SCREEN_DIR%` from the startup JSON (or read `%SCREEN_DIR%\.server-info`).
3. STOP: `.sumela\skills\brainstorming\scripts\stop-server.cmd %SCREEN_DIR%`
</server_management>
