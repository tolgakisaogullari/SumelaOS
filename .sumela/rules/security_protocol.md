...
- Match the **timing** too: do the same dummy hashing work in the not-found branch, or the response time discloses exactly what the status code hides.
