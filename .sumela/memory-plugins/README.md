...
Each plugin contains a `SKILL.md` that defines its routing triggers, commands, and prerequisites. These are registered in `.sumela/SKILL_REGISTRY.md` so the agent can load them on demand.
