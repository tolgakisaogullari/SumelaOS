...
6. SECURITY REVIEW CHECKLIST (Pre-commit gate):
   Before invoking `requesting-code-review`, verify each item. Stack-specific commands and framework names live in project rules under `.openskills/rules/` (e.g., `backend_standards.md`, `mobile_app_development_standards.md`); this skill defines the universal categories.
